...
function draw() {
    ...
    for (let i = 0; i < numLines; i++) {
        ...
        x1 = map(noise(zoff + i * 0.02), 0, 1, width, width + 400)
        y2 = map(cos(zoff + i * 0.002), -1, 1, 0, height)
        x2 = map(noise(zoff + i * 0.02), 0, 1, -400, -100)
        ...
        let r = map(sin(i * zoff * 0.002), -1, 1, 0, 105)
        let g = map(cos(i * zoff * 0.002), -1, 1, 0, 55)
        let b = map(noise(i * zoff * 0.002), 0, 1, 255, 0)
